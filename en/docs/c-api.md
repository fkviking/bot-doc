...
## 10.10. Indicators and Mathematical Statistics
...
#### 10.10.1.2. `TradingDays` and `schedule` for Indicators
...
#### 10.10.1.3. Object `indicators::interval`
...
#### 10.10.1.4. Object `indicators::schedule`
...
### 10.10.2. Simple Moving Average (`SMA`)
...
### 10.10.3. Exponential Moving Average (`EMA`)
...
### 10.10.4. Maximum over Interval (`Max`)
...
### 10.10.5. Minimum over Interval (`Min`)
...
### 10.10.7. Standard Deviation (`StdDev`)
...
### 10.10.9. Relative Strength Index (`RSI`)
...
## 10.15. Most Common Errors in Formulas Leading to Robot Crash
