...
- Added [`ring_deque`](c-api.md#ring-deque) object to the C++ interface, which can save and load its values on robot restart;
...
- Added [ability to save and load indicator values on robot restart](c-api.md#saving-indicator-values-and-collections-between-robot-restarts) to C++ interface
