...
- <details>
    <summary><i>Problem with the exchange trading connection: the robot does not place orders / does not see trades, but the situation does not allow stopping trading for a long time.<a id="faq.lost_orders"></a></i></summary>
...
---
- <details>
    <summary><i>Trading turns on and off spontaneously. What could be causing this?<a id="faq.timetable"></a></i></summary>
...
---
- <details>
    <summary><i>The robot is not trading. Almost all connections are disconnected. What could be the reason?<a id="faq.license"></a></i></summary>
...
---
- <details>
    <summary><i>Added a portfolio, all exchange connections are active, trading is enabled, but orders for the first leg are not being placed. What could be the reason?<a id="faq.prompt"></a></i></summary>
...
---
- <details>
    <summary><i>The required instrument is missing from the exchange instrument list. Where can I get it?<a id="faq.no_security"></a></i></summary>
...
---
- <details>
    <summary><i>New financial instruments were added on the exchange today, but I don't see them in the robot. What should I do?<a id="faq.new_security"></a></i></summary>
...
---
- <details>
    <summary><i>I added a portfolio, changed its settings, but the changes did not apply and the portfolio disappeared. What is happening?<a id="faq.another_user"></a></i></summary>
...
---
- <details>
    <summary><i>The robot has become slower at executing trades. What could be causing this?<a id="faq.making_deals"></a></i></summary>
...
---
- <details>
    <summary><i>Why is volume being placed multiple times at the same spread? My K parameter is non-zero.<a id="faq.limits_shifting"></a></i></summary>
...
---
- <details>
    <summary><i>How can I reduce slippage on second-leg instruments?<a id="faq.k_percent_of_quantity"></a></i></summary>
...
---
- <details>
    <summary><i>I frequently encounter the REASON_FLOOD error. What should I do to avoid it?<a id="faq.reason_flood"></a></i></summary>
...
---
- <details>
    <summary><i>Trades in the robot do not match trades in the terminal. What could be the reason?<a id="faq.deals_mismatch"></a></i></summary>
...
---
- <details>
    <summary><i>I don't see a portfolio, but I'm sure I created it, and the robot won't let me create a new portfolio with the same name. What could be the issue?<a id="faq.filter"></a> </i></summary>
...
---
- <details>
    <summary><i>I cannot create a portfolio—I receive a message saying a portfolio with this name already exists. I definitely did not create such a portfolio. What could be the reason?<a id="faq.not_your_portfolio"></a></i></summary>
...
---
- <details>
    <summary><i>Is there a way to configure the robot to hedge part of the Is_first leg if less than 5 contracts are filled? For example: fill 2 on the first leg, hedge 3 on the second leg (while keeping Count at 5 to 8)?<a id="faq.n_perc_fill"></a></i></summary>
...
---
- <details>
    <summary><i>How to set up notifications for sharp changes in spreads?<a id="faq.notifications"></a></i></summary>
...
---
- <details>
    <summary><i>In the Financial result section, the asset price is often displayed instead of the spread (delta). How does this affect Average sell and buy?<a id="faq.fin_res"></a></i></summary>
...
---
- <details>
    <summary><i>What order types does the robot use? Is it possible for the robot to place market orders?<a id="faq.order_type"></a></i></summary>
...
---
- <details>
    <summary><i>What actions does the robot take when connection is lost on one leg?<a id="faq.connection_lost"></a></i></summary>
...
---
- <details>
    <summary><i>Do I need to keep the browser page open for everything to keep working? What will happen to my positions if I close the browser or restart my computer?<a id="faq.site"></a></i></summary>
...
---   
- <details>
    <summary><i>On futures instruments of the Moscow Exchange, prices in the robot differ from those in the terminal. What could be the reason?<a id="faq.sintetic"></a></i></summary>
...
---
- <details>
    <summary><i>I see error messages when placing orders for the portfolio, starting with "Stop trading!!!", but trading for the portfolio has not been disabled yet, and the errors continue. How is this possible?<a id="faq.stop_trading"></a></i></summary>
...
---
- <details>
    <summary><i>I received an email requesting to stop trading due to a robot update. What exactly should I do?<a id="faq.robot_update"></a></i></summary>
...
---    
- <details>
    <summary><i>Can I create portfolios and make changes to existing ones on non-trading days?<a id="faq.no_trading_days"></a></i></summary>
...
---    
- <details>
    <summary><i>What are the system requirements for the computer that will run the website with robots?<a id="faq.requirements"></a></i></summary>
...
---   
- <details>
    <summary><i>Is it possible to participate in testing conducted by Moscow Exchange on production environment on non-trading day? <a id="faq.moex_testing"></a></i></summary>
...
---
- <details>
    <summary><i>Does the robot require the 'Cancel on Disconnect' option to be enabled in the trading connection? <a id="faq.cod"></a></i></summary>
...
---
- <details>
    <summary><i>The exchange has suspended trading. What actions should I take in the robot? <a id="faq.exchange_stopped"></a></i></summary>
...
---
- <details>
    <summary><i>My portfolio trades and logs have disappeared. What's the cause? <a id="faq.lost_deals"></a></i></summary>
...
---
- <details>
    <summary><i>When using order book trading, the actual spread is worse than the calculated spread, even though there are no stops. <a id="faq.wrong_price"></a></i></summary>
...
---
- <details>
    <summary><i>How do I replace an instrument in the portfolio and in formulas?<a id="faq.replace"></a></i></summary>

    You should open the portfolio settings, select the instrument you want to replace, and click the "Replace" button.

  ![how_replace_button_looks](/bot-doc/docs/00-img/replace_01.png)
  ...
  ![where_to_change_the_instrument_in_all_portfolios_and_formulas](/bot-doc/docs/00-img/replace_02.png)
