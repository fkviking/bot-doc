...
To activate market data connections, select the `Data Connections` widget, check the required market data connections, click the icon <img src="/bot-doc/docs/00-img/icons/settings_black.svg" width="16" height="16"/> in the widget’s top panel, select the robot for which the connection is being enabled, and choose the action `Enable`.

![Alt text](/bot-doc/docs/00-img/3.1_1_2.jpg)

To set up trading connections, select the `Trade connections` widget, click the icon <img src="/bot-doc/docs/00-img/icons/settings_black.svg" width="16" height="16"/> in the widget’s top panel, select the robot for which the connection is being added, and choose the action `Add`.

![Alt text](/bot-doc/docs/00-img/3.1_2_2.jpg)
...
![Doc](/bot-doc/docs/00-img/telegram.png)
...
![Doc](/bot-doc/docs/00-img/3.3_1_1.jpg)
...
- **Stop formulas** <a id="portfolio_actions.stop_formulas"></a> - stops trading for selected portfolios (clears [re_sell](params-description.md#p.re_sell), [re_buy](params-description.md#p.re_buy) flags), attempts to cancel active orders on both legs, and disables schedule (clears `Use timetable` flag).
...
- **To market** <a id="portfolio_actions.to_market"></a> - forcibly aligns positions of the selected portfolios. The behavior is identical to using the [To market](params-description.md#p.to_market) clicker on the selected portfolios.

- **To0** <a id="portfolio_actions.to0"></a> - restricts trading for selected portfolios, allowing trading only in the direction of position closing. Sets the [To0](params-description.md#p.to0) flag for the selected portfolios.

- **Group TradingDays** <a id="portfolio_actions.trading_days"></a> - allows setting trading days for selected portfolios. Behavior is similar to setting trading days in each portfolio’s settings on the [Timetable](params-description.md#p.trading_days) tab, with the difference that only the entered changes are applied. For example, if two portfolios have different trading day lists—one with Monday, Tuesday, Friday, and another with Monday, Tuesday, Friday, Saturday, Sunday—you can add Thursday to both lists via this widget, but the lists will not become identical.
...
![Doc](/bot-doc/docs/00-img/3.5_1(1).jpg) 
...
![Doc](/bot-doc/docs/00-img/3.5_2.jpg) 
...
![Doc](/bot-doc/docs/00-img/3.6_1.png) 
...
![Doc](/bot-doc/docs/00-img/3.6_2.png) 
...
![Doc](/bot-doc/docs/00-img/3.6_3.png) 
...
![Doc](/bot-doc/docs/00-img/wl_ips.jpg)
