...
|![Alt text](/bot-doc/docs/00-img/widgets_list.png)|
|:--:|
| *Fig. 1* |
...
### 3.1.1. Controls of Table-Based Widgets
...
|![Alt text](/bot-doc/docs/00-img/widget_header.png)|
|:--:|
| *Fig. 2* |
...
### 3.1.2. Table Features

|![Alt text](/bot-doc/docs/00-img/table_functions.png)|
|:--:|
| *Fig. 3* |
...
- **Grouping** — grouping table rows by values in a specific column. An example of grouping by the `Robot` column is shown in Figure 4.
 ...
 |![Alt text](/bot-doc/docs/00-img/table_group.png)|
 |:--:|
 | *Fig. 4* |
...
### 3.1.4. Widget State Persistence
 ...
 * `Connected` — displayed only when all market data connections are online or disabled by schedule (this ensures the cell remains green, as both "connected" and "disabled by time" are normal operational states). Examples of these two cases are shown in Figures 6 and 7 below;
  ...
  |![Doc](/bot-doc/docs/00-img/md_connected.png)|
  |:--:|
  | *Fig. 6* |
  
  |![Doc](/bot-doc/docs/00-img/md_closedbytime.png)|
  |:--:|
  | *Fig. 7* |
...
### 3.2.9. Trade connections orders
...
### 3.2.10. Trade connections positions
...
### 3.2.14. Portfolios realtime chart
...
## 3.3. Other User Interface Elements

### 3.3.1. Status Panel

|![Alt text](/bot-doc/docs/00-img/status_panel.png)|
|:--:|
| *Fig. 9* |
...
### 3.3.2. Settings Behind the User Icon

|![Alt text](/bot-doc/docs/00-img/user_settings.png)|
|:--:|
| *Fig. 10* |
